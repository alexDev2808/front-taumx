...
<x-guest-layout>
    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        ...
        <img class="absolute w-full h-full object-cover" src="{{ asset('assets/backgrounds/bg_login.png') }}" alt="background login" />

        <div class="absolute w-5/6 border-8 border-white bg-white rounded-xl m-auto my-9 inset-0 z-10 flex">

            <div class="w-1/2 bg-black h-full">
            </div>

            <div class="w-1/2 bg-white flex flex-col items-center justify-center px-6 py-8">
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="#">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="#" class="text-sm font-medium text-primary-900 hover:underline dark:text-primary-900">¿Olvidaste tu contraseña?</a>
                            </div>
