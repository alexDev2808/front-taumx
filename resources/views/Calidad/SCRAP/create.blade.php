    ...
    <div class="my-4 bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm p-6">
        <form action="{{ route('calidad.scrap.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                ...
                <button
                    type="submit"
                    class="px-4 py-2 bg-primary-700 hover:bg-primary-800 text-white font-bold rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors inline-flex items-center gap-2">
